...
const Appointment = () => {
  ...
  useEffect(() => {
    const tmpData = appointments.docs.reduce(
      (acc, curr) => {
      ...
      >
        ...
        >
          ...
          <Tab.Screen
            ...
            component={AptScreen}
            initialParams={{
              appointments: aptData?.completed,
              type: "completed",
            }}
          />
          <Tab.Screen
            ...
            component={AptScreen}
            initialParams={{
              appointments: aptData?.cancelled,
              type: "cancelled",
            }}
          />
        </Tab.Navigator>
...
function AptScreen({ route }) {
  ...
  const appointmentsRenderItem = ({ item }) => (
    <AppointmentCard
      appointment={item}
      handleDeleteIconCick={handleDeleteIconCick}
    />
  );
